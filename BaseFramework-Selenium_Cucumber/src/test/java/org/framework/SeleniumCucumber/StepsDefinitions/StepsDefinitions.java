...
public class StepsDefinitions {
	...
	public void iAmInAppMainSite() throws FileNotFoundException, IOException {
		String url = SeleniumFuctions.readProperty("MainAppUrlBase");
	...
	public void  i_set_enviroment_value_in_data_scenario(String parameter) throws FileNotFoundException, IOException {
		 SeleniumFuctions.retriveTestData(parameter);
	}
